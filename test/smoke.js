...
// ── transcript prompts ───────────────────────────────────────────────────────
// The user side of a transcript turn is `inputPreview`, and two things decided
// it wrongly: WHICH captured user message it read, and how much of that message
// survived. Kept out of sessionTitleChecks because these fixtures are multi-KB
// and that suite runs a deliberately tiny byte budget to exercise eviction.
...
(async () => {
  ...
  await harnessTokenAccountingChecks();
